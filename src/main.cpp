...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (nHeight > 1499 && nHeight <= 43200) {
        nSubsidy = 10 * COIN; // initial block reward
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 > 43200 && pindexBest->nHeight+1 <= 150000)  {
        nSubsidy = 15 * COIN;
    }
    else if (pindexBest->nHeight+1 > 150001 && pindexBest->nHeight+1 <= 400000)  {
        nSubsidy = 15 * COIN;
    }
    else if (pindexBest->nHeight+1 > 400001 && pindexBest->nHeight+1 <= 600001) {
        nSubsidy = 10 * COIN;
    }
	...
	// end game - further discussion needed
        nSubsidy = 1 * COIN;
    } else if (pindexBest->nHeight+1 > 2400000) {
	// end game - further discussion needed
        nSubsidy = 1 * COIN;
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (pindexBest->nHeight+1 > 1500 && pindexBest->nHeight+1 <= 43200)  {
        nSubsidy = 10 * COIN;
    }
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
    ...
    if (nHeight < 43201) {
	ret = 0;
    } else if (nHeight >= 43201 && nHeight <= 2400000) {
        ret = blockValue * 11 / 14; // MN Reward 80%
    }
    return ret;
}
