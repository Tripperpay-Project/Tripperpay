...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Tripperpay", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Tripperpay</b> version", 0));
...
"Copyright \302\251 2017-2018 The Tripperpay developers", 0));
