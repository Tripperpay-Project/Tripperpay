...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 TRP"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 TRP"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 TRP"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 TRP"));
