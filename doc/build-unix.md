...
If you want to build Tripperpay-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a tripperpay-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the tripperpay directory
BDB_PREFIX="${TRIPPERPAY_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Tripperpay Core to use our own-built instance of BDB
cd $TRIPPERPAY_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip tripperpayd" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build Tripperpayd with compile script
---------------------
...
Security
---------------------
To help make your tripperpay installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, tripperpay should be built with a non-executable stack
